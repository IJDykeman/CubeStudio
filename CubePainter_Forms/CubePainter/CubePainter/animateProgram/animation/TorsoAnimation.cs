...
namespace CubeAnimator
{
    class TorsoAnimation : AnimationSystem
    {
        ...
        public override void handleOrder(List<AnimationType> type, AnimationSystem parent)
        {
            ...
            //rotation = Quaternion.Slerp(rotation, currentTarget.goal, currentTarget.speed / AnimationFunctions.angleBetweenQuaternions(rotation, currentTarget.goal));
